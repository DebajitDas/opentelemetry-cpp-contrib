...
@param segmentSeparator The character that delimits segment boundaries in the
string.
...
@param nSegments The number of segments of the first string that should be in
the returned string
