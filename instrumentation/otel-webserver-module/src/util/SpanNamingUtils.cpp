...
string into the specified boost::dynamic_bitset.

This function is used to parse the the url components list from the UI.

@param s The string to parse.  Segment numbers in this string should be
separated by URI_SUFFIX_KEY_SEPARATOR_STR.  Any segment number that contains a
character other than a decimal digit will be ignored.
@param result A bitset where each integer parsed out of the specified string s,
will have its corresponding bit in the bitset set.  Since the integers parsed
