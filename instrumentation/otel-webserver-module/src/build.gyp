    ...
    'conditions': [
      ['OS=="linux"', {
        ...
        'libraries': [
          ...
          '$(ANSDK_DIR)/opentelemetry/$(OPENTELEMETRY_VERSION)/lib/libopentelemetry_common.so',
          '$(ANSDK_DIR)/opentelemetry/$(OPENTELEMETRY_VERSION)/lib/libopentelemetry_resources.so',
          '$(ANSDK_DIR)/opentelemetry/$(OPENTELEMETRY_VERSION)/lib/libopentelemetry_trace.so',
          '$(ANSDK_DIR)/opentelemetry/$(OPENTELEMETRY_VERSION)/lib/libopentelemetry_otlp_recordable.so',
          '$(ANSDK_DIR)/opentelemetry/$(OPENTELEMETRY_VERSION)/lib/libopentelemetry_exporter_ostream_span.so',
        ...
        'include_dirs': [
          ...
          '../include/util',
          '../include/core',
          '$(ANSDK_DIR)/opentelemetry/$(OPENTELEMETRY_VERSION)/include/',
          '$(BOOST_INCLUDE)'
        ],
      ...
      ['OS=="win"', {
        ...
        'libraries': [
          ...
          '$(ANSDK_DIR)/boost/1.55.0/lib/libboost_filesystem-vc120-$(APPD_BOOST_LIB_FLAGS)-1_55.lib',
          '$(ANSDK_DIR)/boost/1.55.0/lib/libboost_atomic-vc120-$(APPD_BOOST_LIB_FLAGS)-1_55.lib',
          '$(ANSDK_DIR)/boost/1.55.0/lib/libboost_system-vc120-$(APPD_BOOST_LIB_FLAGS)-1_55.lib',
          '$(ANSDK_DIR)/boost/1.55.0/lib/libboost_thread-vc120-$(APPD_BOOST_LIB_FLAGS)-1_55.lib',
          '$(ANSDK_DIR)/boost/1.55.0/lib/libboost_chrono-vc120-$(APPD_BOOST_LIB_FLAGS)-1_55.lib',
          '$(ANSDK_DIR)/boost/1.55.0/lib/libboost_atomic-vc120-$(APPD_BOOST_LIB_FLAGS)-1_55.lib',
          '$(ANSDK_DIR)/boost/1.55.0/lib/libboost_date_time-vc120-$(APPD_BOOST_LIB_FLAGS)-1_55.lib',
          '$(ANSDK_DIR)/boost/1.55.0/lib/libboost_regex-vc120-$(APPD_BOOST_LIB_FLAGS)-1_55.lib',
