...
otel_ngx_module otel_monitored_modules[] = {
    ...
    {"ngx_http_auth_basic_module",
     ...
     0,
     1},
    {"ngx_http_access_module", 0, {NGX_HTTP_ACCESS_PHASE}, ngx_http_otel_access_handler, 0, 1},
    {"ngx_http_static_module", 0, {NGX_HTTP_CONTENT_PHASE}, ngx_http_otel_static_handler, 0, 1},
    {"ngx_http_gzip_static_module",
     ...
     0,
     1},
    {"ngx_http_dav_module", 0, {NGX_HTTP_CONTENT_PHASE}, ngx_http_otel_dav_handler, 0, 1},
    {"ngx_http_autoindex_module",
     ...
     0,
     1},
    {"ngx_http_index_module", 0, {NGX_HTTP_CONTENT_PHASE}, ngx_http_otel_index_handler, 0, 1},
    {"ngx_http_random_index_module",
     ...
     0,
     1},
    {"ngx_http_log_module", 0, {NGX_HTTP_LOG_PHASE}, ngx_http_otel_log_handler, 0, 1},
    {"ngx_http_try_files_module",
     ...
     0,
     1},
    {"ngx_http_mirror_module", 0, {NGX_HTTP_PRECONTENT_PHASE}, ngx_http_otel_mirror_handler, 0, 1}};
...
static ngx_command_t ngx_http_opentelemetry_commands[] = {
    ...
    {ngx_string("NginxModuleEnabled"),
     ...
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleEnabled), NULL},

    {ngx_string("NginxModuleOtelSpanExporter"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleOtelSpanExporter), NULL},

    {ngx_string("NginxModuleOtelSslEnabled"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_FLAG,
     ngx_conf_set_flag_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleOtelSslEnabled), NULL},

    {ngx_string("NginxModuleOtelSslCertificatePath"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleOtelSslCertificatePath), NULL},

    {ngx_string("NginxModuleOtelExporterEndpoint"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleOtelExporterEndpoint), NULL},

    {ngx_string("NginxModuleOtelSpanProcessor"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleOtelSpanProcessor), NULL},

    {ngx_string("NginxModuleOtelSampler"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleOtelSampler), NULL},

    {ngx_string("NginxModuleServiceName"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleServiceName), NULL},

    {ngx_string("NginxModuleServiceNamespace"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleServiceNamespace), NULL},

    {ngx_string("NginxModuleServiceInstanceId"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleServiceInstanceId), NULL},

    {ngx_string("NginxModuleOtelMaxQueueSize"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_size_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleOtelMaxQueueSize), NULL},

    {ngx_string("NginxModuleOtelScheduledDelayMillis"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleOtelScheduledDelayMillis), NULL},

    {ngx_string("NginxModuleOtelExportTimeoutMillis"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleOtelExportTimeoutMillis), NULL},

    {ngx_string("NginxModuleOtelMaxExportBatchSize"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_size_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleOtelMaxExportBatchSize), NULL},

    {ngx_string("NginxModuleResolveBackends"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_flag_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleResolveBackends), NULL},

    {ngx_string("NginxModuleTraceAsError"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_flag_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleTraceAsError), NULL},

    {ngx_string("NginxModuleReportAllInstrumentedModules"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_flag_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleReportAllInstrumentedModules), NULL},

    {ngx_string("NginxModuleWebserverContext"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE3,
     ngx_otel_context_set, NGX_HTTP_LOC_CONF_OFFSET, 0, NULL},

    {ngx_string("NginxModuleMaskCookie"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_flag_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleMaskCookie), NULL},

    {ngx_string("NginxModuleCookieMatchPattern"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleCookieMatchPattern), NULL},

    {ngx_string("NginxModuleMaskSmUser"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_flag_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleMaskSmUser), NULL},

    {ngx_string("NginxModuleDelimiter"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleDelimiter), NULL},

    {ngx_string("NginxModuleSegment"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleSegment), NULL},

    {ngx_string("NginxModuleMatchfilter"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleMatchfilter), NULL},

    {ngx_string("NginxModuleMatchpattern"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleMatchpattern), NULL},

    {ngx_string("NginxModuleSegmentType"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleSegmentType), NULL},

    {ngx_string("NginxModuleSegmentParameter"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_opentelemetry_loc_conf_t, nginxModuleSegmentParameter), NULL},
...
static char *ngx_http_opentelemetry_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
  ...
  ngx_conf_merge_value(conf->nginxModuleReportAllInstrumentedModules,
                       prev->nginxModuleReportAllInstrumentedModules, 0);
  ...
  ngx_conf_merge_str_value(conf->nginxModuleOtelSpanExporter, prev->nginxModuleOtelSpanExporter,
                           "");
  ngx_conf_merge_str_value(conf->nginxModuleOtelExporterEndpoint,
                           prev->nginxModuleOtelExporterEndpoint, "");
  ngx_conf_merge_value(conf->nginxModuleOtelSslEnabled, prev->nginxModuleOtelSslEnabled, 0);
  ngx_conf_merge_str_value(conf->nginxModuleOtelSslCertificatePath,
                           prev->nginxModuleOtelSslCertificatePath, "");
  ...
  ngx_conf_merge_size_value(conf->nginxModuleOtelMaxQueueSize, prev->nginxModuleOtelMaxQueueSize,
                            2048);
  ngx_conf_merge_msec_value(conf->nginxModuleOtelScheduledDelayMillis,
                            prev->nginxModuleOtelScheduledDelayMillis, 5000);
  ngx_conf_merge_msec_value(conf->nginxModuleOtelExportTimeoutMillis,
                            prev->nginxModuleOtelExportTimeoutMillis, 30000);
  ngx_conf_merge_size_value(conf->nginxModuleOtelMaxExportBatchSize,
                            prev->nginxModuleOtelMaxExportBatchSize, 512);

  ngx_conf_merge_str_value(conf->nginxModuleSegmentType, prev->nginxModuleSegmentType, "First");
  ngx_conf_merge_str_value(conf->nginxModuleSegmentParameter, prev->nginxModuleSegmentParameter,
                           "2");
...
/*
        ...
        Each HTTP request passes through a sequence of phases. In each phase a distinct type of
   processing is performed on the request. Module-specific handlers can be registered in most
   phases, and many standard nginx modules register their phase handlers as a way to get called at a
   specific stage of request processing. Phases are processed successively and the phase handlers
   are called once the request reaches the phase. Following is the list of nginx HTTP phases:
        ...
        On every phase you can register any number of your handlers. Exceptions are following
   phases:
        ...
        while (phase_index < otel_monitored_modules[res].phase_count)
        {
          ...
          switch (ph)
          {
            case NGX_HTTP_POST_READ_PHASE:
              ...
              {
                h[res] = ((ngx_http_handler_pt *)cmcf->phases[NGX_HTTP_POST_READ_PHASE]
                              .handlers.elts)[prp];
                ((ngx_http_handler_pt *)cmcf->phases[NGX_HTTP_POST_READ_PHASE].handlers.elts)[prp] =
                    otel_monitored_modules[res].handler;
                prp++;
              }
              break;
            ...
            case NGX_HTTP_SERVER_REWRITE_PHASE:
              ...
              {
                h[res] = ((ngx_http_handler_pt *)cmcf->phases[NGX_HTTP_SERVER_REWRITE_PHASE]
                              .handlers.elts)[srp];
                ((ngx_http_handler_pt *)cmcf->phases[NGX_HTTP_SERVER_REWRITE_PHASE]
                     .handlers.elts)[srp] = otel_monitored_modules[res].handler;
                srp++;
              }
              break;
            ...
            case NGX_HTTP_REWRITE_PHASE:
              ...
              {
                h[res] =
                    ((ngx_http_handler_pt *)cmcf->phases[NGX_HTTP_REWRITE_PHASE].handlers.elts)[rp];
                ((ngx_http_handler_pt *)cmcf->phases[NGX_HTTP_REWRITE_PHASE].handlers.elts)[rp] =
                    otel_monitored_modules[res].handler;
                rp++;
              }
            ...
            case NGX_HTTP_PREACCESS_PHASE:
              ...
              {
                h[res] = ((ngx_http_handler_pt *)cmcf->phases[NGX_HTTP_PREACCESS_PHASE]
                              .handlers.elts)[pap];
                ((ngx_http_handler_pt *)cmcf->phases[NGX_HTTP_PREACCESS_PHASE].handlers.elts)[pap] =
                    otel_monitored_modules[res].handler;
                pap++;
              }
              break;
            ...
            case NGX_HTTP_ACCESS_PHASE:
              ...
              {
                h[res] =
                    ((ngx_http_handler_pt *)cmcf->phases[NGX_HTTP_ACCESS_PHASE].handlers.elts)[ap];
                ((ngx_http_handler_pt *)cmcf->phases[NGX_HTTP_ACCESS_PHASE].handlers.elts)[ap] =
                    otel_monitored_modules[res].handler;
                ap++;
              }
            ...
            case NGX_HTTP_CONTENT_PHASE:
              ...
              {
                h[res] =
                    ((ngx_http_handler_pt *)cmcf->phases[NGX_HTTP_CONTENT_PHASE].handlers.elts)[cp];
                ((ngx_http_handler_pt *)cmcf->phases[NGX_HTTP_CONTENT_PHASE].handlers.elts)[cp] =
                    otel_monitored_modules[res].handler;
                cp++;
              }
            ...
            case NGX_HTTP_LOG_PHASE:
              ...
              {
                h[res] =
                    ((ngx_http_handler_pt *)cmcf->phases[NGX_HTTP_LOG_PHASE].handlers.elts)[lp];
                ((ngx_http_handler_pt *)cmcf->phases[NGX_HTTP_LOG_PHASE].handlers.elts)[cp] =
                    otel_monitored_modules[res].handler;
                lp++;
              }
              break;
            case NGX_HTTP_PRECONTENT_PHASE:
              ...
              {
                h[res] = ((ngx_http_handler_pt *)cmcf->phases[NGX_HTTP_PRECONTENT_PHASE]
                              .handlers.elts)[pcp];
                ((ngx_http_handler_pt *)cmcf->phases[NGX_HTTP_PRECONTENT_PHASE]
                     .handlers.elts)[pcp] = otel_monitored_modules[res].handler;
                pcp++;
              }
              break;
...
static ngx_int_t ngx_http_opentelemetry_init_worker(ngx_cycle_t *cycle)
{
  ...
  ngx_log_error(NGX_LOG_ERR, cycle->log, 0,
                "mod_opentelemetry: ngx_http_opentelemetry_init_worker: Initializing Nginx Worker "
                "for process with PID: %s",
                s);
  ...
  {
    ngx_log_error(NGX_LOG_ERR, cycle->log, 0,
                  "mod_opentelemetry: ngx_http_opentelemetry_init_worker: Not able to allocate "
                  "memeory for worker conf");
    return NGX_ERROR;
  }
...
static void ngx_http_opentelemetry_exit_worker(ngx_cycle_t *cycle)
{
  ...
  {
    ngx_log_error(NGX_LOG_ERR, cycle->log, 0,
                  "mod_opentelemetry: ngx_http_opentelemetry_exit_worker: Exiting Nginx Worker for "
                  "process with PID: %s**********",
                  worker_conf->pid);
  }
}
...
static void ngx_otel_set_global_context(ngx_http_opentelemetry_loc_conf_t *prev)
{
  ...
  {
    if ((prev->nginxModuleServiceName).data != NULL &&
        (prev->nginxModuleServiceNamespace).data != NULL &&
        (prev->nginxModuleServiceInstanceId).data != NULL)
    {
...
static APPD_SDK_STATUS_CODE otel_startInteraction(ngx_http_request_t *r, const char *module_name)
{
  ...
  if (!r || r->internal)
  {
    ngx_writeTrace(r->connection->log, __func__,
                   "It is not a main Request, not starting interaction");
    return res;
  }
  ...
  if (ctx && ctx->otel_req_handle_key)
  {
    ...
    if (propagationHeaders == NULL)
    {
      ngx_writeError(r->connection->log, __func__,
                     "Failed to allocate memory for propagation headers");
      return APPD_STATUS(fail);
    }
    ngx_writeTrace(r->connection->log, __func__, "Starting a new module interaction for: %s",
                   module_name);
    int ix = 0;
    res = startModuleInteraction((void *)ctx->otel_req_handle_key, module_name, "", resolveBackends,
                                 propagationHeaders, &ix);
...
static void otel_payload_decorator(ngx_http_request_t *r,
...
*/
static void otel_stopInteraction(ngx_http_request_t *r,
                                 ...
                                 void *request_handle_key)
{
  ...
  *msg               = '\0';
  ...
  APPD_SDK_STATUS_CODE res =
      stopModuleInteraction(otel_req_handle_key, backendName, backendType, errCode, msg);
  if (APPD_ISFAIL(res))
  {
    ngx_writeError(r->connection->log, __func__, "Error: Stop Interaction failed, result code: %d",
                   res);
  }
...
{
  return (r->err_status >= LOWEST_HTTP_ERROR_CODE) ||
         (r->headers_out.status >= LOWEST_HTTP_ERROR_CODE);
}
...
static ngx_flag_t ngx_initialize_opentelemetry(ngx_http_request_t *r)
{
  ...
  {
    ngx_writeTrace(r->connection->log, __func__,
                   "Opentelemetry SDK already initialized for process with PID: %s",
                   worker_conf->pid);
    return true;
  }
  ...
  if (conf->nginxModuleEnabled)
  {
    ...
    {
      ngx_writeError(r->connection->log, __func__,
                     "Not Able to allocate memory for the Env Config");
      return false;
    }
    int ix = 0;
    ...
    for (int context_i = 0; context_i < c_count; context_i++)
    {
      ...
      char *name            = ngx_pcalloc(r->pool, (contexts[context_i].sNamespace).len +
                                                       (contexts[context_i].sName).len +
                                                       (contexts[context_i].sInstanceId).len + 1);
      if (name != NULL)
      {
    ...
    if (APPD_ISSUCCESS(res))
    {
      ...
      ngx_writeTrace(r->connection->log, __func__,
                     "Initializing Agent Core succceeded for process with PID: %s",
                     worker_conf->pid);
      return true;
    }
    else
    {
      ngx_writeError(r->connection->log, __func__, "Agent Core Init failed, result code is %d",
                     res);
      return false;
    }
  }
...
static void stopMonitoringRequest(ngx_http_request_t *r, APPD_SDK_HANDLE_REQ request_handle_key)
{
  ngx_http_opentelemetry_loc_conf_t *ngx_conf =
  ...
  if (otel_requestHasErrors(r))
  {
    ...
    res = endRequest(otel_req_handle_key, msg);
  }
  else
  {
    res = endRequest(otel_req_handle_key, msg);
...
static void startMonitoringRequest(ngx_http_request_t *r)
{
  ...
  {
    ngx_writeTrace(r->connection->log, __func__,
                   "Not a Main Request(sub-request or internal redirect)");
    return;
  }
  else if (!ngx_initialize_opentelemetry(r)) /* check if Appd Agent Core is initialized */
  {
    ngx_writeError(r->connection->log, __func__,
                   "Opentelemetry Agent Core did not get initialized");
    return;
  }
...
{
  // This will be last handler to be be encountered before a request ends and response is finally
  // sent back to client
  //  Here, End the main trace, span created by Webserver Agent and the collected data will be
  //  passed to the backend It will work as ngx_http_opentelemetry_log_transaction_end
...
{
  char *name = ngx_pcalloc(r->pool, (conf->nginxModuleServiceNamespace).len +
                                        (conf->nginxModuleServiceName).len +
                                        (conf->nginxModuleServiceInstanceId).len + 1);
...
static void traceConfig(ngx_http_request_t *r, ngx_http_opentelemetry_loc_conf_t *conf)
{
  ngx_writeTrace(r->connection->log, __func__,
                 ...
                 "(SegmentParameter=\"%s\")"
                 " }",
                 conf->nginxModuleEnabled, (conf->nginxModuleOtelExporterEndpoint).data,
                 conf->nginxModuleOtelSslEnabled, (conf->nginxModuleOtelSslCertificatePath).data,
                 (conf->nginxModuleOtelSpanExporter).data,
                 (conf->nginxModuleOtelSpanProcessor).data, (conf->nginxModuleOtelSampler).data,
                 (conf->nginxModuleServiceNamespace).data, (conf->nginxModuleServiceName).data,
                 (conf->nginxModuleServiceInstanceId).data, conf->nginxModuleOtelMaxQueueSize,
                 conf->nginxModuleOtelScheduledDelayMillis,
                 conf->nginxModuleOtelExportTimeoutMillis, conf->nginxModuleOtelMaxExportBatchSize,
                 conf->nginxModuleResolveBackends, conf->nginxModuleTraceAsError,
                 conf->nginxModuleReportAllInstrumentedModules, conf->nginxModuleMaskCookie,
                 conf->nginxModuleMaskSmUser, (conf->nginxModuleSegmentType).data,
