...
public:
  ...
  MOCK_METHOD(appd::core::IRequestProcessingEngine *,
              getRequestProcessor,
              (std::string & name),
              (override));
  ...
  MOCK_METHOD(void,
              addContext,
              (const std::string &contextName, std::shared_ptr<appd::core::TenantConfig> newConfig),
              (override));
...
public:
  ...
  MOCK_METHOD(APPD_SDK_STATUS_CODE,
              ...
              (appd::core::IEnvReader & reader,
               appd::core::TenantConfig &tenantConfig,
               appd::core::SpanNamer &spanNamer),
              (override));
  /*MOCK_METHOD(APPD_SDK_STATUS_CODE, ReadMandatoryFromReader,
      (appd::core::IEnvReader& reader, const std::string& varName, unsigned
...
public:
  ...
  MOCK_METHOD(appd::core::IRequestProcessingEngine *, getRequestProcessingEngine, (), (override));
};

class MockContext : public appd::core::IContext
{
public:
  MOCK_METHOD(void, initContext, (std::shared_ptr<appd::core::SpanNamer> spanNamer), (override));
