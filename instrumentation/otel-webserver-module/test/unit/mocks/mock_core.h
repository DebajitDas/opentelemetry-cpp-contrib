...
public:
  ...
  MOCK_METHOD(std::shared_ptr<appd::core::IContext>, getWebServerContext,
              (std::string & name), (override));
};
...
public:
  ...
  MOCK_METHOD(APPD_SDK_STATUS_CODE, ReadFromPassedSettings,
              (APPD_SDK_ENV_RECORD * env, unsigned numberOfRecords,
  ...
  MOCK_METHOD(APPD_SDK_STATUS_CODE, ReadOptionalFromReader,
              (appd::core::IEnvReader & reader, const std::string &varName,
               bool &result),
              (override));
  MOCK_METHOD(APPD_SDK_STATUS_CODE, ReadOptionalFromReader,
              (appd::core::IEnvReader & reader, const std::string &varName,
...
public:
  ...
  MOCK_METHOD(appd::core::IRequestProcessingEngine *,
              getRequestProcessingEngine, (), (override));
};
...
public:
  ...
  MOCK_METHOD(std::shared_ptr<appd::core::TenantConfig>, getConfig, (),
              (override));
};
